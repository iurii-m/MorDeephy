...
def parse_args():
    ...
    parser.add_argument('-n', '--protocol_name', default="protocol_sd_real", type=str, help='name of the protocol')
...
if __name__ == '__main__':
    ...
    #Loading protocol
    dataset = (np.loadtxt('%s/%s/%s' %(args.benchmark_protocols_path,args.protocol_name,'dataset.txt'), dtype='str')).tolist()
    ...
    for i, file in enumerate(dataset):
        ...
        label = int(labels[i])
        filename = '%s/%s' %(args.data_path,str(file))
